...
CREATE TABLE DB_LISTA_MINIMO.PRODUTO (
	...
	NOME VARCHAR(55) NOT NULL,
	TIPO_PRODUTO INTEGER NOT NULL, -- Unidade de Medida 0 Qtd 1 Kg
    DATA_CADASTRO DATETIME NOT NULL,
    INDEX (ID_PRODUTO)
);
...
-- CLIENTES 
INSERT INTO DB_LISTA_MINIMO.CLIENTE (NOME_CLIENTE, CPF, DATA_NASCIMENTO, DATA_CADASTRO, TIPO_USUARIO, NOME_USUARIO, SENHA) VALUES ('Ana Souza', '68535626077', '2000-11-12', '2023-06-18', '1', 'anasouza', 'senha123');
