...
DROP USER IF EXISTS 'SISTEMA_MINIMO'@'%';

FLUSH PRIVILEGES;

CREATE USER 'SISTEMA_MINIMO'@'%' IDENTIFIED BY 'XpTO$98245015#';

GRANT SELECT, INSERT , UPDATE, DELETE ON DB_LISTA_MINIMO.* TO 'SISTEMA_MINIMO'@'%';
